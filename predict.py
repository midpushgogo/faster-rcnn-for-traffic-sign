...
def predict_single_image(img_path, model_rpn, model_classifier_only, cfg, class_mapping):
    ...
    for cls_num, box in boxes.items():
        ...
        # if class_mapping[cls_num] == 'mandatory':
        #     class_mapping[cls_num] = 'prohibitory'
        # elif class_mapping[cls_num] == 'prohibitory':
        #     class_mapping[cls_num] = 'danger'
        # elif class_mapping[cls_num] == 'danger':
        #     class_mapping[cls_num] = 'mandatory'

        print(class_mapping[cls_num] + ":")
        for b in boxes_nms:
            b[0], b[1], b[2], b[3] = get_real_coordinates(ratio, b[0], b[1], b[2], b[3])
            print('{} prob: {}'.format(b[0: 4], b[-1]))
            result_li.append(img_path[7:]+';'+str(int(b[0]))+';'+str(int(b[1]))+';'+str(int(b[2]))+';'+str(int(b[3]))+';'+class_mapping[cls_num])
...
#    class_mapping = {0: 'danger', 1: 'mandatory', 2: 'other1', 3: 'prohibitory', 4: 'other3', 5: 'other2', 6: 'other4', 7: 'bg'}
